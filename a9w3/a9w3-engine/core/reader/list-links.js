...
function showLabel(par,page){
    parent.W3GUI.getAddressLabelList(function(ls){
        ...
        drawAddressListLabelView(par,document.getElementById("ARTLISTS"),ls);
        parent.W3GUI.getAddressLabelLink(par,function(ls2){
            drawAddressLinkView(page,document.getElementById("ARTLINKS"),ls2);
        });
    });
}
// month
